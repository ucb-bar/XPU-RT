...
def _resolve_template_source(rel_path: str, *, repo_root: str | Path | None) -> Path | None:
    ...
    if repo_root is not None:
        ...
        if candidate.exists():
            return candidate
    # Repo-relative (Path(__file__).parents[3] == repo root after src-layout flatten)
