"""LLM tool implementations — wrappers around existing xpu_rt analyzers
...
- Ported passes: full-surface Phase 2/3 transformations from
  :mod:`xpu_rt.ir.payload.passes` (auto-registers on import).
...
import xpu_rt.ir.payload.passes as _ported_passes  # noqa: F401
from xpu_rt.llm.tools import megakernel, observability, verification
