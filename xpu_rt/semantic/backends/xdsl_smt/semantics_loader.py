...
_XPU_RT_OP_HANDLERS: dict[type, Any] = {}
...
def register_xpu_rt_semantics() -> None:
    ...
    """
    log.info("smt.semantics.register", num_handlers=len(_XPU_RT_OP_HANDLERS))
