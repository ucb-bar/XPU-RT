...
- ``device(spec_path)`` -- load a HardwareSpec YAML file, generate a target,
  and return a :class:`XpuRtDevice` encapsulating the spec, profile,
...
class CompiledModel:
    ...
    Attributes:
        ...
        device: The XpuRtDevice used for compilation.
...
def device(
    ...
    Returns:
        A :class:`XpuRtDevice` ready for use with :func:`compile_model`.
...
def compile_model(
    ...
    *,
    ...
    Args:
        ...
        target_device: A :class:`XpuRtDevice` from :func:`device`.
