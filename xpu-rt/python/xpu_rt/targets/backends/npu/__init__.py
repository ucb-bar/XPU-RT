...
``xpu_rt.targets.backend`` (TargetBackendProtocol).
"""

from xpu_rt.targets.backends.npu.memory_map import (
    NPU_DRAM_BASE,
    NPU_DRAM_SIZE,
    NPU_VMEM_BASE,
    NPU_VMEM_SIZE,
...
from xpu_rt.targets.backends.npu.program_emitter import NpuProgramEmitter
