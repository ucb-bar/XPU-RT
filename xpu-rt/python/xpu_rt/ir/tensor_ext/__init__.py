"""``xpu_rt.tensor_ext`` -- supplement to xDSL's tensor dialect.
...
Register on a ``Context`` with::
    ...
    ctx.register_dialect("xpu_rt.tensor_ext", lambda: TensorExt)
"""

from __future__ import annotations

from xpu_rt.ir.tensor_ext.dialect import ALL_ATTRS, ALL_OPS, TensorExt
from xpu_rt.ir.tensor_ext.ops import ConcatOp, PackOp, UnpackOp
