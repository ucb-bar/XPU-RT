...
def test_request_then_register_then_lookup(sm) -> None:
    out = request_refinement(
        sm,
        session_id="sess1",
        kernel_fingerprint="fp1",
        prior_source="def kernel(x): return x",
