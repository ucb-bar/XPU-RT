...
class TestDiscoveryMigration:
    ...
    def test_new_public_location_works(self) -> None:
        from xpu_rt.targets.gpu.nvidia.common.discovery import (
            cublasdx_available,
            cutlass_available,
...
class TestArchCostTableMigration:
    ...
    def test_blackwell_leaf_constants(self) -> None:
        from xpu_rt.targets.gpu.nvidia.blackwell import cost
    ...
    def test_hopper_leaf_constants(self) -> None:
        from xpu_rt.targets.gpu.nvidia.hopper import cost
    ...
    def test_ampere_leaf_constants(self) -> None:
        from xpu_rt.targets.gpu.nvidia.ampere import cost
    ...
    def test_lookup_helper_uses_leaf(self) -> None:
        ...
        from xpu_rt.kernels.cost.etc_predict import _lookup_arch_tflops
...
class TestSmTagMigration:
    ...
    def test_new_public_location_works(self) -> None:
        from xpu_rt.targets.gpu.nvidia.common import arch_to_cublasdx_sm
    ...
    def test_both_paths_return_same_function(self) -> None:
        ...
        from xpu_rt.targets.gpu.nvidia.common.sm_tag import (
