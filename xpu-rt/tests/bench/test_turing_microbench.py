...
def test_microbench_matmul_fp16_512x1024x512(device: str, capsys) -> None:
    ...
    assert r.our_us < 15 * r.eager_us, f"matmul too slow: ours={r.our_us}us eager={r.eager_us}us"
