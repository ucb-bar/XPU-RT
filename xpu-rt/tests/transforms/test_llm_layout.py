...
class TestSolverConfig:
    ...
    def test_format_and_parse(self):
        from compgen.agent.prompts.solver_config import SolverConfigContext, format_prompt as fmt_sc, parse_response as parse_sc
...
class TestRecipeSeed:
    ...
    def test_format_and_parse(self):
        from compgen.agent.prompts.recipe_seed import RecipeSeedContext, format_prompt as fmt_rs, parse_response as parse_rs
...
class TestGuardPropose:
    ...
    def test_format_and_parse(self):
        from compgen.agent.prompts.guard_propose import GuardProposeContext, format_prompt as fmt_gp, parse_response as parse_gp
