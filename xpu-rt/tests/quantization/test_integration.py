...
class TestCaptureIntegration:
    ...
    def test_fp8_e4m3_po2_scheme(self) -> None:
        """QuantizationConfig(scheme='fp8_e4m3_po2') should quantize via XPU-RT."""
...
class TestFullPipeline:
    ...
    def test_quantize_verify_pipeline(self) -> None:
        ...
        from xpu_rt.quantization.verify import compare_quantized_accuracy, npu_alignment_check
    ...
    def test_quantize_rewrite_export_pipeline(self) -> None:
        ...
        from xpu_rt.quantization.fp8_config import FP8E4M3Po2Config
        from xpu_rt.quantization.verify import npu_alignment_check
        from torchao.quantization import quantize_
...
class TestContractsIntegration:
    ...
    def test_f8e4m3_in_dtype_bytes(self) -> None:
        from xpu_rt.ir.payload.contracts import _dtype_bytes
