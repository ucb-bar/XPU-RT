...
def load_and_plot(json_path: str, save_path: str | None = None):
    ...
    # Optional bitstream-level identity for the y-axis labels. Persisted by
    # output_scheduled_json (postprocessing.py) on schedules generated by
    # the post-Q31 toolchain; older schedules don't have it and fall back
    # to the bare CPU_P / CPU_E labels.
    profile_hw = metadata.get("profile_hw")
