#!/usr/bin/env bash
#
# Cross-compile libxpu_rt for bare-metal RISC-V and run the smoke
...
# wrapper in tests/runtime/test_libxpu_rt_bare.py.

set -euo pipefail

XPU_RT_ROOT="${XPU_RT_ROOT:-/scratch2/agustin/XPU-RT}"
LIB_ROOT="$XPU_RT_ROOT/runtime/native/libxpu_rt"
