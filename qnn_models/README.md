...
### CaseStudy: Profile All SmolVLA Models

**Convert and profile the 7 simpler submodels** (single-input, no KV-cache):
...
**Profile the expert models** (multi-input, requires special handling):
