...
def simple_test():
    ...
    plot.plot_optimization_schedule(workload.get_durations(), t, alpha, num_jobs, len(workload.machines), machines, transfer_times, save_path="plots/simple_test.png")
...
def param_sweep_simple():
    ...
    for num_jobs in num_jobs_list:
        for num_machines in num_machines_list:
            ...
            plot_filename = f"runtime/schedule_simple_jobs{num_jobs}_machines{num_machines}.png"
            print(f"Saving plot to {plot_filename}...")
            try:
                plot.plot_optimization_schedule(durations, t, alpha, num_jobs, num_machines, workload.machines, transfer_times, save_path=plot_filename)
