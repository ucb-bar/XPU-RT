...
def greedy_pack_test() -> float:
    ...
    """
    transfer_times = np.array([[0, 10, 50], [10, 0, 200], [50, 200, 0]])
    ...
    plot.plot_optimization_schedule(
        ...
        transfer_times,
        save_path="plots/greedy_schedule.pdf",
        plot_title="Greedy Packing Schedule",
    )
...
def convex_pack_test() -> float:
    ...
    plot.plot_optimization_schedule(
        ...
        len(workload.machines),
        transfer_times,
        save_path="plots/convex_schedule.pdf",
        plot_title="Convex Packing Schedule",
    )
