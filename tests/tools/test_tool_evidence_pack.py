...
from tools.dev.build_tool_evidence_pack import build  # type: ignore[import-not-found]
...
def test_main_returns_zero_when_no_claims_unmet(tmp_path: Path):
    ...
    from tools.dev.build_tool_evidence_pack import main  # type: ignore[import-not-found]
