...
def _have_gpu() -> bool:
    from xpu_rt.runtime.gpu_executor import gpu_available
...
class TestGPUExecutorCPUSide:
    ...
    def test_require_gpu_raises_on_missing(self):
        from xpu_rt.runtime.gpu_executor import GPUNotAvailable, gpu_available
        ...
        with pytest.raises(GPUNotAvailable):
            ...
            from xpu_rt.runtime.gpu_executor import launch_triton_kernel
    ...
    def test_load_emission_manifest_missing_file_raises(self, tmp_path: Path):
        from xpu_rt.runtime.gpu_executor import load_emission_manifest
...
class TestGPUExecutorOnGPU:
    def test_matmul_launch_has_zero_diff_vs_torch(self, tmp_path: Path):
        ...
        from xpu_rt.pipeline import compile_through_pipeline
        from xpu_rt.runtime.gpu_executor import launch_triton_kernel
...
class TestGPUDiffHarness:
    def test_cpu_host_returns_skipped_report(self):
        ...
        from xpu_rt.options import cuda_h100_defaults
        from xpu_rt.runtime.gpu_diff import compile_and_diff_gpu
...
class TestDistributedAdapter:
    def test_distributed_available_returns_bool(self):
        from xpu_rt.runtime.distributed import distributed_available

        assert isinstance(distributed_available(), bool)

    def test_current_env_reports_state(self):
        from xpu_rt.runtime.distributed import current_env
    ...
    def test_init_if_needed_world_size_1_skips(self):
        from xpu_rt.runtime.distributed import init_if_needed
    ...
    def test_all_reduce_single_process_is_identity(self):
        import torch
        from xpu_rt.runtime.distributed import DistributedAdapter
