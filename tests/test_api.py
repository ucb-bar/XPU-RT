...
from xpu_rt.api import XpuRtDevice, CompiledModel, compile_model, device
...
class TestDevice:
    ...
    def test_device_all_exemplars(self, yaml_file: Path, tmp_path: Path) -> None:
        """Every exemplar YAML must produce a valid XpuRtDevice."""
...
class TestPackageExports:
    ...
    def test_import_classes_from_package(self) -> None:
        from xpu_rt import XpuRtDevice, CompiledModel

        assert XpuRtDevice is not None
