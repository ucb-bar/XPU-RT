 ...
 *
 * Every primitive in libxpu_rt that historically used pthreads
...
#ifndef XPU_RT_RT_PLATFORM_H_
#define XPU_RT_RT_PLATFORM_H_
...
#include "xpu_rt_platform_defs.h"
