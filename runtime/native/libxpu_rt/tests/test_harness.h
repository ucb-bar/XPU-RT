/*
 * Tiny zero-dependency test harness for libxpu_rt C tests.
 *
 * Usage:
...
#ifndef XPU_RT_RT_TEST_HARNESS_H_
#define XPU_RT_RT_TEST_HARNESS_H_
...
#endif /* XPU_RT_RT_TEST_HARNESS_H_ */
